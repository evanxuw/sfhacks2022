...
export default function Navbar() {
  ...
  return (
    <div>
      <nav className='flex items-center py-2 flex-wrap px-4 tracking-wider bg-primary text-secondary'>
        <Link to='/'>
          <span className=' mr-4 inline-flex items-center  cursor-pointer font-base'>
            <img className='h-20 w-22' src={secondaryLogo} alt='' />
          </span>
        </Link>
        <button
              ...
              <div className='relative my-6 mx-auto w-screen'>
                <div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-secondary outline-none focus:outline-none'>
                  ...
                  <div className='grid place-items-center text-xl py-2 gap-2 w-full mb-4'>
                    <Link to='/'>
                      <span className='lg:inline-flex px-3 mx-3 py-2 rounded items-center justify-center  cursor-pointer'>
                        Home
                      </span>
                    </Link>

                    <span
                      className='lg:inline-flex px-3 mx-3 py-2 rounded items-center justify-center  cursor-pointer'
        ...
        <div className='hidden top-navbar w-full lg:inline-flex lg:flex-grow lg:w-auto'>
          <div className='lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full text-xl lg:items-center items-start flex flex-col lg:h-auto space-x-2 mr-12'>
            <Link to='/'>
              <span className='lg:inline-flex lg:w-auto w-full px-3 py-2 rounded items-center justify-center  cursor-pointer'>
                Home
              </span>
            </Link>

            <span
              className='lg:inline-flex lg:w-auto w-full px-3 py-2 rounded items-center justify-center  cursor-pointer'
              onClick={() => auth.signOut()}
            >
              Log out
            </span>
            ...
            <Link to='/faq'>
              <span className='lg:inline-flex lg:w-auto w-full px-3 py-1 rounded items-center justify-center  cursor-pointer bg-white'>
                FAQ
              </span>
            </Link>
          </div>
